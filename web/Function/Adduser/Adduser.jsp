...
<div class="container-fluid  text-center" style="margin:auto;padding:150px;width: 500px;height: 500px">
    <form action="http://localhost:8080/WebGoodsManagementSystem_war_exploded/Function/Add/Add.jsp" method="post">
        ...
        <input type="password" name="password" id="password" placeholder="请输入用户密码" class="text-center "style="width: 250px;height: 50px"required>
        <div class="bg-success mt-3"style="width: 250px;height:auto">请赋予权限</div><br>
        普通管理员<input class="mt-3" type="radio"name="power" value="Client">   高级管理员<input type="radio" name="power" value="Manager">
        <button type="submit" class="btn-primary mt-5 ms-3"style="width: 150px ">添加</button>
    </form>
</div>
</body>
<body>
...
request.setCharacterEncoding("UTF-8");
    ...
    re.regist(request.getParameter("name"),request.getParameter("account"),request.getParameter("password"),request.getParameter("power"));
%>
</body>
</html>
