...
<body>
<%
    String sql="select*from goods.export";
    ...
    while(re.next()!=false)
    {
        if(flag==1)
        {
            out.print("<div class=\"text-center  h1 text-dark bg-primary\">出货详情</div>");
            out.print("<table style=\"width: 1000px\" class=\" mt-5 table table-hover container-fluid bg-primary table-bordered  text-white\" border=\"1\">");
            out.println("<th ><tr class=\"h3 text-center\"><td>"+"</td><td>出货情况"+"</td><td>"+"</td></tr></th>");
            out.println("<th ><tr class=\"h3\"><td>商品名称"+"</td><td>商品价格"+"</td><td>出货件数"+"</td><td>发货方式</td><td>出货时间</td></tr></th>");
            flag++;
        }
        out.println("<tr class=\"h3\"><td>"+re.getString("name")+"</td><td>"+re.getString("price")+"</td><td>"+re.getString("number")+"</td><td>"+re.getString("method")+"</td><td>"+re.getString("time")+"</td></tr>");
