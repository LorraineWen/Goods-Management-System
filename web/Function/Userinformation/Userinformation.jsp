...
<%
    ...
    while(re.next()!=false)
    {
        if(flag==1)
        {
            out.print("<div class=\"text-center  h1 text-dark bg-primary\">用户信息</div>");
        ...
        out.println("<tr class=\"h3\"><td>"+re.getString("name")+"</td><td>"+re.getString("account")+"</td><td>"+re.getString("password")+"</td><td>"+re.getString("power")+"</td></tr>");
