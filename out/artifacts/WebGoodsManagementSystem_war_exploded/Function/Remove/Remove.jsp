<%@ page import="functioninterfaceimp.Removeimp" %>
<%@ page import="functioninterface.Remove" %>
...
<div class="container-fluid  text-center" style="margin:auto;padding:150px;width: 500px;height: 500px">
    <form action="http://localhost:8080/WebGoodsManagementSystem_war_exploded/Function/Remove/Remove.jsp" method="post">
