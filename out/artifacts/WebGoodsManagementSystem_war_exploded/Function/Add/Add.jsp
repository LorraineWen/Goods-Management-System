...
<div class="container-fluid  text-center" style="margin:auto;padding:150px;width: 500px;height: 500px">
    <form method="post" action="http://localhost:8080/WebGoodsManagementSystem_war_exploded/Function/Add/Add.jsp">
        <label for="name" class="form-label mt-5">名称:</label>
        <input type="text" name="name" id="name" placeholder="请输入商品名称" class="text-center "style="width: 250px;height: 50px"required><br>
        <label for="price"class="form-label mt-5">价格:</label>
        <input type="text" name="price" id="price" placeholder="请输入商品价格" class="text-center "style="width: 250px;height: 50px"required><br>
        <label for="number" class="mt-5 form-label">件数:</label>
        <input type="text" name="number" id="number" placeholder="请输入商品件数" class="text-center "style="width: 250px;height: 50px"required>
